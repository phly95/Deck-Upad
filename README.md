...
* **QoS Optimized Repeater:** Continues to acheive low latency while maintaining a wifi connection on the host with a single WiFi card. QoS allows stable gameplay, even while downloading in the background.
